...
# 💡 Para migrar: usar build_services() en lugar de arbitrage_detector global
# 📍 Referencia histórica: muestra como funcionaba el arbitrage detector antes de DI estricto
...
def main():
    ...
    raise RuntimeError("Test roto por migración DI - usar build_services() en lugar de arbitrage_detector global")
...
# 
# from app.services.arbitrage_detector import arbitrage_detector, ArbitrageDetector  # ❌ YA NO EXISTE
