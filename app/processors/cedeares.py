...
class CEDEARProcessor:
    ...
    def _load_cedeares_data(self) -> list:
        ...
        if not data_path.exists():
            ...
            if not data_path.exists():
                print("❌ No se encontró byma_cedeares_pdf.json ni byma_cedeares_with_ratios.json")
                print("💡 Ejecuta: python download_byma_pdf.py")
                return []
            else:
...
# cedeares_processor = CEDEARProcessor()  # DEPRECATED - use build_services() 